...
export const metadata: Metadata = {
  ...
  description:
    "Datenschutzerklärung von klimajob.ch — Informationen zur Erhebung und Verarbeitung personenbezogener Daten gemäss Schweizer DSG.",
  alternates: {
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-2xl">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Wenn Sie sich über klimajob.ch auf eine Stelle bewerben, werden die von Ihnen
