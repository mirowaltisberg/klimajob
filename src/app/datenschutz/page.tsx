...
export const metadata: Metadata = {
  title: "Datenschutz",
  description: "Datenschutzhinweise für klimajob.ch",
    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      <header className="border-b bg-white">
        <div className="container mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="font-bold text-slate-900">klimajob.ch</Link>
        ...
        <article className="rounded-2xl border bg-white p-6 sm:p-9 shadow-sm space-y-8">
          <div>
            ...
            <p className="mt-3 text-slate-600">
              Diese Seite informiert über die Verarbeitung von Angaben im Bewerbungsbereich von klimajob.ch.
            </p>
          </div>
