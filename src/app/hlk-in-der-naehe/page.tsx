...
export const metadata: Metadata = {
  title: "Kältetechniker in der Nähe | Jobs in deiner Stadt finden",
  description:
    "Kältetechniker Jobs in deiner Nähe — finde offene Stellen in Zürich, Bern, Basel, Luzern, St. Gallen und allen Schweizer Städten. Tägliche Updates.",
  alternates: { canonical: "/hlk-in-der-naehe" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Kältetechniker in der Nähe", item: `${SITE_URL}/hlk-in-der-naehe` },
  ],
};
        ...
        <section className="bg-primary/5 border-b">
          <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-4xl">
            <nav className="text-sm text-slate-500 mb-3" aria-label="Breadcrumb">
              ...
              <span className="text-slate-700">Kältetechniker in der Nähe</span>
            </nav>
            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
              Kältetechniker <span className="text-primary">in deiner Nähe</span>
            </h1>
            <p className="text-slate-600 text-lg leading-relaxed max-w-3xl">
              HLK-Fachkräfte (Heizung, Lüftung, Klima, Kälte) sorgen für Komfort und Energieeffizienz in Schweizer Gewerbeimmobilien, Spitälern und Industrieanlagen. Wähle deine Stadt und finde offene Stellen mit Pendelradius — typischerweise findest du in 25 km Umkreis 2- bis 3-mal mehr passende Inserate.
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-10 max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            { HLK_CITIES.map((c) => (
              ...
              >
                <div className="font-semibold text-slate-900 mb-1">Kältetechniker Jobs {c.name}</div>
        ...
        <section className="bg-slate-50 border-y">
          <div className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
            ...
            <ol className="space-y-3 text-slate-700 list-decimal list-inside">
              <li>Wähle oben deine Stadt — du bekommst die offenen Kältetechniker Stellen für die Region.</li>
