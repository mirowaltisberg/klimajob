...
export const metadata: Metadata = {
  title: "Kältesystem-Monteur in der Nähe | Jobs in deiner Stadt finden",
  description:
    "Klimastellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
  alternates: { canonical: "/hlk-in-der-naehe" },
  openGraph: {
    title: "Kältesystem-Monteur in der Nähe | Jobs in deiner Stadt finden",
    description: "Klimastellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
    url: "/hlk-in-der-naehe",
    type: "website",
  },
  twitter: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Kältesystem-Monteur in der Nähe", item: `${SITE_URL}/hlk-in-der-naehe` },
  ],
};
        ...
        <section className="trade-hero">
          <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-4xl">
            <nav className="text-sm text-slate-500 mb-3" aria-label="Breadcrumb">
              ...
              <span className="text-slate-700">Kältesystem-Monteur in der Nähe</span>
            </nav>
            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
              Kältesystem-Monteur <span className="text-primary">in deiner Nähe</span>
            </h1>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-10 max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            { HLK_CITIES.map((c) => (
              ...
              >
                <div className="font-semibold text-slate-900 mb-1">Kältesystem-Monteur Jobs {c.name}</div>
