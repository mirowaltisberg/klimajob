...
export const metadata: Metadata = {
  ...
  description:
    "Erhalten Sie Zugang zum Kandidatenpool von klimajob.ch — qualifizierte Klima-Fachkräfte in der Schweiz.",
};
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-lg">
        ...
        <p className="text-slate-600 mb-6 leading-relaxed">
          Mit dem Kandidatenzugang von klimajob.ch finden Sie qualifizierte
          Klima-Fachkräfte in der ganzen Schweiz. Dieser Service befindet sich
          derzeit im Aufbau.
        </p>
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          ...
          <Button asChild className="w-full">
            <a href="mailto:info@klimajob.ch">info@klimajob.ch kontaktieren</a>
          </Button>
        </div>
