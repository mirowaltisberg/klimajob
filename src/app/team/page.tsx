...
export const metadata: Metadata = {
  ...
  description:
    "Quellen, Methodik und Grenzen der redaktionellen Inhalte auf klimajob.ch.",
  alternates: {
    canonical: "/team",
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main id="main-content" className="flex-1 container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-3xl">
        ...
        <p className="text-slate-600 mt-3 text-base sm:text-lg leading-relaxed">
          klimajob.ch ergänzt die Stellensuche mit kurzen Informationen zum
          Klimaberuf, zur Ausbildung und zur Einordnung von Lohnangaben.
        </p>
        ...
        <section className="mt-10 space-y-6">
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              Kälte- und Klimagewerk. Pauschale Aussagen über regionale Nachfrage,
