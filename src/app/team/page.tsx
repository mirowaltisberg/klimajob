...
export const metadata: Metadata = {
  title: "Über die Redaktion | klimajob.ch",
  description:
    "Wer hinter den redaktionellen Inhalten von klimajob.ch steht: Recherche, Quellen, Methodik und unser Anspruch an Schweizer Lohn- und Branchendaten.",
  alternates: {
    canonical: "/team",
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="border-b header-blur sticky top-0 z-30">
        <div className="container mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-2">
          <Link href="/" className="flex items-center shrink-0">
            <Image
              src="/logo.svg"
              alt="klimajob.ch — Klimajobs in der Schweiz"
              width={142}
              height={29}
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-3xl">
        ...
        <p className="text-slate-600 mt-3 text-base sm:text-lg leading-relaxed">
          Die Redaktion von klimajob.ch erstellt redaktionelle Inhalte zu Berufen,
          Löhnen und regionalen Arbeitsmärkten in der Schweizer Klima- und
          Kältetechnik-Branche.
        </p>
        ...
        <section className="mt-10 space-y-6">
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              Stellenanzeigen aus der Schweizer Klima- und Kältetechnik-Branche
          ...
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              der Schweizer Klima- und Kältetechnik-Branche — insbesondere{" "}
              <a
              ...
              Stellenausschreibungen aus, die auf klimajob.ch indexiert sind. Die
          ...
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              Inserate werden auf klimajob.ch grundsätzlich anonymisiert
