...
export const metadata: Metadata = {
  ...
  description:
    "Kontaktieren Sie das Team von klimajob.ch — wir helfen Ihnen bei Fragen rund um Stelleninserate und Bewerbungen.",
  alternates: {
    canonical: "/kontakt",
  },
};
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-lg">
        ...
        <p className="text-slate-600 mb-6 leading-relaxed">
          Haben Sie Fragen zu klimajob.ch? Ob Sie als Arbeitgeber inserieren
