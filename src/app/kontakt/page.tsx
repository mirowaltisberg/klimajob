...
export const metadata: Metadata = {
  ...
  description:
    "Kontaktmöglichkeit für Fragen und Hinweise zu klimajob.ch.",
  alternates: {
    canonical: "/kontakt",
  },
  openGraph: {
    title: "Kontakt & Support | klimajob.ch",
    description: "Kontaktmöglichkeit für Fragen und Hinweise zu klimajob.ch.",
    url: "/kontakt",
    type: "website",
  },
  twitter: {
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main id="main-content" className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-lg">
        ...
        <p className="text-slate-600 mb-6 leading-relaxed">
          Haben Sie eine Frage oder einen Hinweis zu klimajob.ch? Schreiben
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 space-y-4">
          ...
          <Button asChild className="w-full">
            <a href="mailto:info@klimajob.ch">E-Mail senden</a>
          </Button>
        </div>
