...
export const metadata: Metadata = {
  ...
  title: {
    default: "458 Klima Jobs Schweiz 2026 | Offene Stellen finden",
  ...
  keywords: [
    "Klimajobs",
    "Klimajobs Schweiz",
    "Kältetechniker EFZ Jobs",
    "Klimatechniker Jobs",
    "Lüftungsanlagenbauer Jobs",
  ...
  openGraph: {
    title: "458 Klima Jobs Schweiz 2026 | Offene Stellen finden",
    description:
      "Finde aktuelle Klima- und Kältetechnik Jobs in der Schweiz. Stellen für Kältetechniker EFZ, Klimatechniker, Lüftungsanlagenbauer & mehr. Jetzt Lebenslauf einreichen.",
    type: "website",
    url: "/",
...
const organizationSchema = {
  ...
  description:
    "klimajob.ch ist die spezialisierte Jobbörse für Klima- und Kältetechnik-Fachkräfte in der Schweiz. Finde offene Stellen als Kältetechniker EFZ, Klimatechniker, Lüftungsanlagenbauer, Projektleiter HLKK und mehr.",
  foundingDate: "2025",
  areaServed: {
    "@type": "Country",
    name: "Switzerland",
  ...
  sameAs: [
    "https://www.youtube.com/@klimajob",
    "https://www.facebook.com/klimajob",
    "https://www.instagram.com/klimajob",
    "https://www.linkedin.com/company/klimajob",
    "https://twitter.com/klimajob",
  ],
};
