...
export const metadata: Metadata = {
  ...
  description:
    "AGB von klimajob.ch — Allgemeine Geschäftsbedingungen für die Nutzung der Jobbörse.",
  alternates: {
    canonical: "/agb",
  },
};
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              klimajob.ch, betrieben von der QERO AG, Ifangstrasse 91, 8153 Rümlang, Schweiz.
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              klimajob.ch ist eine Online-Jobbörse, die Arbeitgebern die Möglichkeit bietet,
