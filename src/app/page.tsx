...
const homepageMetadata: Metadata = {
  ...
  description:
    "Finde Stellenangebote für Kältesystem-Monteur EFZ, Kältemonteur, Servicetechnik, Planung und Projektleitung Klima in der Schweiz.",
          ...
          <section className={`trade-hero relative z-20 overflow-visible ${hasActiveSearch ? "pb-5 pt-8 sm:pb-7 sm:pt-10 md:pt-12" : "pb-6 pt-10 sm:pb-9 sm:pt-14 md:pt-20"}`}>
            <div className="container mx-auto max-w-6xl px-4 sm:px-6">
              <div className="trade-hero-grid">
                <div>
                  <p className="trade-kicker">Klima · ganze Schweiz</p>
                  ...
                  <p className="mt-5 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-lg">
                    Stelleninserate für Kälte- und Klimainstallation, Montage, Planung, Service und Projektleitung. Kompakt filtern nach Beruf, Ort und Pensum.
                  </p>
                </div>
                <div className="isobar-schematic" aria-hidden="true">
                  <svg viewBox="0 0 360 230" focusable="false">
                    <path className="isobar-schematic__line isobar-schematic__line--one" d="M-15 42c70-42 151-36 202 2s123 39 190-1" />
                    <path className="isobar-schematic__line isobar-schematic__line--two" d="M-20 90c78-37 151-27 204 8s122 33 196-9" />
                    <path className="isobar-schematic__line isobar-schematic__line--three" d="M-11 145c64-31 138-27 199 3s126 27 184-11" />
                    <path className="isobar-schematic__line isobar-schematic__line--four" d="M-18 197c83-35 159-18 211 5s116 23 184-14" />
                    <path className="isobar-schematic__air" d="M63 28v137m0 0-11-18m11 18 11-18" />
                    <circle className="isobar-schematic__node" cx="253" cy="98" r="10" />
                  </svg>
                  <span className="isobar-schematic__label">Luftlinie 04 · Stellensuche CH</span>
                </div>
              </div>
