...
import type { EditorialContent } from "@/data/editorial/klimajob";
import { EDITORIAL_BYLINE } from "@/data/editorial/klimajob";

interface EditorialIntroProps {
  /** Display label for the role, e.g. "Kältetechniker EFZ" */
  role: string;
