...
const DEFAULT_ROLE = "Kältetechniker EFZ";
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            <Image
              src="/logo.svg"
              alt="klimajob.ch — Jobbörse für Klima- und Kältetechnik-Fachkräfte in der Schweiz"
              width={142}
              height={29}
            ...
            <p className="text-sm leading-relaxed">
              Die spezialisierte Jobbörse für Klima- und Kältetechnik-Fachkräfte in der Schweiz.
          ...
          <nav aria-label="Berufe">
            ...
            <ul className="space-y-1.5">
              {FOOTER_ROLES.map((role) => (
                <li key={role}>
                  <Link
                    href={`/klimajobs/${toRoleSlug(role)}/${toCantonSlug(DEFAULT_CANTON)}`}
          ...
          {/* Canton navigation — each links to the Kältetechniker page for that canton */}
          <nav aria-label="Kantone">
            ...
            <ul className="space-y-1.5">
              {FOOTER_CANTONS.map((canton) => (
                <li key={canton}>
                  <Link
                    href={`/klimajobs/${toRoleSlug(DEFAULT_ROLE)}/${toCantonSlug(canton)}`}
                    className="text-sm hover:text-white transition-colors duration-150"
                  >
                    Klimajobs {canton}
                  </Link>
        ...
        <div className="border-t border-slate-800 pt-6 mt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <p>© {new Date().getFullYear()} klimajob.ch — Alle Rechte vorbehalten.</p>
          ...
          <div className="flex items-center gap-4">
            <a href="https://facebook.com/klimajob" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-slate-400 hover:text-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
            </a>
            <a href="https://instagram.com/klimajob" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-slate-400 hover:text-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
            </a>
            <a href="https://twitter.com/klimajob" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-slate-400 hover:text-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
            </a>
            <a href="https://linkedin.com/company/klimajob" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-slate-400 hover:text-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect width="4" height="12" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
            </a>
            <a href="https://youtube.com/@klimajob" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-slate-400 hover:text-white transition-colors">
