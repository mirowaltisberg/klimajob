...
const DEFAULT_QUERY = "Kältetechniker";
...
const RESPONSIBILITY_TEMPLATES = [
  "Installation und Inbetriebnahme von Klima- und Kälteanlagen.",
  "Wartung und Entstörung von HLKK-Systemen.",
  "Montage von Lüftungskanälen und Klimageräten.",
  ...
  "Befüllung und Kontrolle von Kältemittelanlagen.",
  "Mitarbeit bei Optimierung von Klimasystemen und Energieverbrauch.",
];

const REQUIREMENT_TEMPLATES = [
  "Abgeschlossene Ausbildung im Bereich Kälte-, Klima- oder Heizungstechnik (EFZ oder gleichwertig).",
  "Sorgfältige und selbstständige Arbeitsweise.",
  "Teamfähigkeit und klare Kommunikation auf Deutsch.",
  "Erfahrung in HLKK-Projekten von Vorteil.",
  ...
  "Gute Kenntnisse der Schweizer Normen und Kältemittelvorschriften.",
...
function buildGeneratedJob(
  ...
  const focusText = primaryFocus
    ...
    : "mit Fokus auf moderne Klimaprojekte";
