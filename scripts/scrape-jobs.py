"""
Scrape Swiss HVAC/climate (Klima/Kälte/Lüftung) jobs using python-jobspy and output JSON.
...
def normalize_job(raw: dict, idx: int) -> dict | None:
    ...
    stable_id = f"scraped-klima-{url_hash}"
        ...
        try:
            ...
            for job in existing:
                ...
                if url and url not in seen_urls:
                    ...
                    job["id"] = f"scraped-klima-{url_hash}"
